            ...
            <div className="flex-1 max-w-sm mx-3">
              <div className="relative">
                <input
                  ...
                  className="w-full pl-8 pr-3 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-300 focus:border-transparent transition-all duration-200 text-sm"
                />
